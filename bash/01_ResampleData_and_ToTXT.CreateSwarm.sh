...
SWARM_PATH=`echo /data/SFIMJGC_HCP7T/2025_BCBL_VisitNIH/swarm.${USERNAME}/01_ResampleData_and_ToTXT.SWARM.sh`
LOGS_DIR=`echo /data/SFIMJGC_HCP7T/2025_BCBL_VisitNIH/logs.${USERNAME}/01_ResampleData_and_ToTXT.logs`
...
# ---------------------
echo "#swarm -f ${SWARM_PATH} -g 8 -t 8 --time 00:30:00 --logdir ${LOGS_DIR} --sbatch \"--export AFNI_COMPRESSOR=GZIP\"" > ${SWARM_PATH}
...
for SBJ in ${subjects[@]}
do
  echo "export SBJ=${SBJ}; sh ${BASH_DIR}/01_ResampleData_and_ToTXT.sh" >> ${SWARM_PATH}
done
